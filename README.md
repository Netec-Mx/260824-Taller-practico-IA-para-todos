...
Durante el taller, cada participante seleccionará una tarea real de su trabajo que pueda beneficiarse del uso de IA generativa. A partir de esa necesidad, analizará la tarea, diseñará un flujo de trabajo, construirá y refinará los prompts necesarios, evaluará la calidad de los resultados y determinará los riesgos, limitaciones y controles necesarios para utilizar la solución responsablemente.

El resultado no será únicamente un ejercicio de prompting, sino un prototipo funcional de un caso de uso que el participante podrá adaptar y aplicar después del taller.
